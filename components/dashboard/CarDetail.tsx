...
const CarDetail = () => {
  return (
    <>
      <div className="items-stretch dark:bg-[#1D1E21] dark:border-none border border-[#F1F1F1] flex w-full flex-col py-px xl:px-5 xl:pt-6 xl:pb-3 rounded-xl relative my-10 lg:mt-0">
